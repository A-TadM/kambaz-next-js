...
//"use client"; make onClick handler (inside {}) as client component
...
tell browsers to render the gaps.
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Lasagna
        <ol id="wd-your-favorite-recipe">
          <li>Preheat the oven to 375°F.</li>
          <li>Add ground beef, onion, and garlic and brown the meat.</li>
          <li>Stir in the marinara sauce and simmer for 10 minutes.</li>
          <li>Combine the ricotta cheese, egg, and Parmesan cheese.</li>
          <li>Spread a thin layer of the meat sauce on the bottom of baking dish.</li>
          <li>Place a layer of no-boil lasagna noodles over the sauce, top with cheese mixture, then meat sauce.</li>
          <li>Create the middle layers.</li>
          <li>Place the last layer of noodles on top, cover with the meat sauce, and sprinkle generously with shredded mozzarella cheese.</li>
          <li>Bake the lasagna for 30 minutes with foil on top.</li>
          <li>Remove the foil and bake for another 15 minutes.</li>
          <li>Rest before serving for at least 10 minutes.</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>Harry Potter</li>
          <li>Funny in Farsi: A Memoir of Growing Up Iranian in America</li>
          <li>A Man Called Ove</li>
          <li>The Forty Rules of Love</li>
        </ul>
      </div>
      ...
      <div id="wd-images"> 
        ...
        <img id="wd-starship" width="400px"  
             src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" alt="nothing" />
        <br />
        Loading a local image:
        <br />
        <Image id="wd-teslabot" src="/images/teslabot.jpg" alt="A robot which is like a human." width={200} height={200} />
       </div>
       ...
       <div id="wd-forms">
         ...
         <form id="wd-text-fields">
          ...
          <button type="button"
                  ...
                  id="wd-all-good">Hello World!</button>
